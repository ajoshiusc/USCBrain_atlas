...
#a2009s.32k_fs.reduce3.very_smooth.'+scan_type+'.dfs'))
    ...
    dfs_left_sm = readdfs(os.path.join('/big_disk/ajoshi/coding_ground.donotdelete/hybridatlas/src/','100307.BCI2reduce3.very_smooth.'+scan_type+'.dfs'))
    dfs_left = readdfs(os.path.join('/big_disk/ajoshi/coding_ground.donotdelete/hybridatlas/src/','100307.BCI2reduce3.very_smooth.'+scan_type+'.dfs'))
